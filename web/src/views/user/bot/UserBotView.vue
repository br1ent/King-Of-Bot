...
const add_bot = () => {
    ...
    $.ajax({
        url: "https://app4397.acapp.acwing.com.cn/api/user/bot/add",
        type: "post",
        data: {
            title: botadd.title,
...
const remove_bot = (bot) => {
    botadd.errMsg = "";
    $.ajax({
        url: "https://app4397.acapp.acwing.com.cn/api/user/bot/remove",
        type: "post",
        headers: {
            Authorization: "Bearer " + store.state.user.token
        },
...
const update_bot = (bot) => {
    ...
    $.ajax({
        url: "https://app4397.acapp.acwing.com.cn/api/user/bot/update",
        type: "post",
        data: {
            bot_id: bot.id,
            title: bot.title,
